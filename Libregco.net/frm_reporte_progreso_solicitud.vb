...
Public Class frm_reporte_progreso_solicitud
    ...
    Private Sub frm_reporte_progreso_solicitud_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Me.CenterToParent()
    ...
    Private Sub txtIDSolicitud_Leave(sender As Object, e As EventArgs) Handles txtIDSolicitud.Leave
        ...
        txtSolicitud.Text = Convert.ToString(cmd.ExecuteScalar())
        Con.Close()
        If txtSolicitud.Text = "" Then txtIDSolicitud.Clear()
    End Sub
