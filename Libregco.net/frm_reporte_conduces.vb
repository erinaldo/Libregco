...
Public Class frm_reporte_conduces
    ...
    Private Sub frm_reporte_conduces_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
            Me.CenterToParent()
    ...
    Private Sub txtIDFactura_Leave(sender As Object, e As EventArgs) Handles txtIDFactura.Leave
        ConLibregco.Open()
        cmd = New MySqlCommand("Select SecondID from FacturaDatos Where IDFacturaDatos='" + txtIDFactura.Text + "'", ConLibregco)
