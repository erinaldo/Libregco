...
Public Class frm_reporte_notas_debito_credito_cxp
    ...
    Private Sub frm_reporte_notas_debito_credito_cxp_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Me.CenterToParent()
