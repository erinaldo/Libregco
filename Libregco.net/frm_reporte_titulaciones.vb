...
Public Class frm_reporte_titulaciones
    Dim sqlQ As String=""
    ...
    Private Sub frm_reporte_titulaciones_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Me.CenterToParent()
    ...
    Private Sub txtIDTipoCargado_Leave(sender As Object, e As EventArgs) Handles txtIDTipoCargado.Leave
        ConLibregco.Open()
        cmd = New MySqlCommand("Select Descripcion from TipoCargadoPagare Where IDTipoCargadoPagare='" + txtIDTipoCargado.Text + "'", ConLibregco)
    ...
    Private Sub btnTipoCargado_Click(sender As Object, e As EventArgs) Handles btnTipoCargado.Click
    ...
    Private Sub btnBuscar_Click(sender As Object, e As EventArgs) Handles btnBuscar.Click
        Try
            ...
            '@Pagare
            If txtIDPagare.Text = "" Then
                crParameterDiscreteValue.Value = 0
            Else
                crParameterDiscreteValue.Value = txtIDPagare.Text
            End If
            crParameterFiledDefinitions = ObjRpt.DataDefinition.ParameterFields
