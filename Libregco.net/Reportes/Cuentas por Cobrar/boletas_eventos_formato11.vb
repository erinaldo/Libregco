...
Public Class boletas_eventos_formato1
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "boletas_eventos_formato1.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Libregco.boletas_eventos_formato1.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_IDEvento() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class Cachedboletas_eventos_formato1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As boletas_eventos_formato1 = New boletas_eventos_formato1()
        rpt.Site = Me.Site
        Return rpt
    End Function
