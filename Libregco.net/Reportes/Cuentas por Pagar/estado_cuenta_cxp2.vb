...
Public Class estado_cuenta_cxp
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Libregco.estado_cuenta_cxp.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedestado_cuenta_cxp
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As estado_cuenta_cxp = New estado_cuenta_cxp()
        rpt.Site = Me.Site
        Return rpt
    End Function
