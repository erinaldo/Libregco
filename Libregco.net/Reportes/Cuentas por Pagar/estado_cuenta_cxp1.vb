...
Public Class estado_cuenta_cxp1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Libregco.estado_cuenta_cxp1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedestado_cuenta_cxp1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As estado_cuenta_cxp1 = New estado_cuenta_cxp1()
        rpt.Site = Me.Site
        Return rpt
    End Function
