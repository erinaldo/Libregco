...
Public Class nomina_detallada1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Libregco.nomina_detallada1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachednomina_detallada1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As nomina_detallada1 = New nomina_detallada1()
        rpt.Site = Me.Site
        Return rpt
    End Function
