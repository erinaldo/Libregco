...
Public Class nomina_detallada
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Libregco.nomina_detallada.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachednomina_detallada
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As nomina_detallada = New nomina_detallada()
        rpt.Site = Me.Site
        Return rpt
    End Function
