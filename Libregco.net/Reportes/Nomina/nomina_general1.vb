...
Public Class nomina_general1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Libregco.nomina_general1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachednomina_general1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As nomina_general1 = New nomina_general1()
        rpt.Site = Me.Site
        Return rpt
    End Function
