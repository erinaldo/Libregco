...
Public Class sobres_pago_nomina
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Libregco.sobres_pago_nomina.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedsobres_pago_nomina
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As sobres_pago_nomina = New sobres_pago_nomina()
        rpt.Site = Me.Site
        Return rpt
    End Function
