...
Public Class recibo_abono_prestamos_media_pagina1
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "recibo_abono_prestamos_media_pagina1.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Libregco.recibo_abono_prestamos_media_pagina1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrecibo_abono_prestamos_media_pagina1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As recibo_abono_prestamos_media_pagina1 = New recibo_abono_prestamos_media_pagina1()
        rpt.Site = Me.Site
        Return rpt
    End Function
