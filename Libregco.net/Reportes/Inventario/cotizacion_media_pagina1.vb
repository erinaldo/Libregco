...
Public Class cotizacion_media_pagina1
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "cotizacion_media_pagina1.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Libregco.cotizacion_media_pagina1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedcotizacion_media_pagina1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As cotizacion_media_pagina1 = New cotizacion_media_pagina1()
        rpt.Site = Me.Site
        Return rpt
    End Function
