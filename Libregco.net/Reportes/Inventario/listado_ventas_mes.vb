...
Public Class listado_ventas_mes
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Libregco.listado_ventas_mes.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedlistado_ventas_mes
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As listado_ventas_mes = New listado_ventas_mes()
        rpt.Site = Me.Site
        Return rpt
    End Function
