...
Public Class listado_conduces1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Libregco.listado_conduces1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedlistado_conduces1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As listado_conduces1 = New listado_conduces1()
        rpt.Site = Me.Site
        Return rpt
    End Function
