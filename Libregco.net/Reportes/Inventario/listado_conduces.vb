...
Public Class listado_conduces
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Libregco.listado_conduces.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedlistado_conduces
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As listado_conduces = New listado_conduces()
        rpt.Site = Me.Site
        Return rpt
    End Function
