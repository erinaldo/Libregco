...
Public Class compra_pagina_completa1
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "compra_pagina_completa1.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Libregco.compra_pagina_completa1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedcompra_pagina_completa1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As compra_pagina_completa1 = New compra_pagina_completa1()
        rpt.Site = Me.Site
        Return rpt
    End Function
