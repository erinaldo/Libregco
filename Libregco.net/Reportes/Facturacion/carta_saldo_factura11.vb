...
Public Class carta_saldo_factura1
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "carta_saldo_factura1.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Libregco.carta_saldo_factura1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedcarta_saldo_factura1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As carta_saldo_factura1 = New carta_saldo_factura1()
        rpt.Site = Me.Site
        Return rpt
    End Function
