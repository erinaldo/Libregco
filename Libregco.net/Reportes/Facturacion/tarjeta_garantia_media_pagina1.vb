...
Public Class tarjeta_garantia_media_pagina1
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "tarjeta_garantia_media_pagina1.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Libregco.tarjeta_garantia_media_pagina1.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_IDSerial() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class Cachedtarjeta_garantia_media_pagina1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As tarjeta_garantia_media_pagina1 = New tarjeta_garantia_media_pagina1()
        rpt.Site = Me.Site
        Return rpt
    End Function
