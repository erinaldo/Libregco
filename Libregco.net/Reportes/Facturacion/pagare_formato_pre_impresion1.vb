...
Public Class pagare_formato_pre_impresion1
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "pagare_formato_pre_impresion1.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Libregco.pagare_formato_pre_impresion1.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_Ocultar() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class Cachedpagare_formato_pre_impresion1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As pagare_formato_pre_impresion1 = New pagare_formato_pre_impresion1()
        rpt.Site = Me.Site
        Return rpt
    End Function
