...
Public Class entrega_voluntaria
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Libregco.entrega_voluntaria.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedentrega_voluntaria
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As entrega_voluntaria = New entrega_voluntaria()
        rpt.Site = Me.Site
        Return rpt
    End Function
