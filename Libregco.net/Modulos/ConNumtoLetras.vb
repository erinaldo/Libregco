        ...
        Try
            If IsNumeric(CStr(value)) Then
                ...
                Select Case value
                    ...
                    Case Is <= 29 : Num2Text = "VEINTI" & Num2Text(value - 20)
                    ...
                    Case 200 : Num2Text = "DOSCIENTOS"
                    Case 300 : Num2Text = "TRESCIENTOS"
                    Case 400 : Num2Text = "CUATROCIENTOS"
                    Case 500 : Num2Text = "QUINIENTOS"
                    Case 600 : Num2Text = "SEISCIENTOS"
                    Case 700 : Num2Text = "SETECIENTOS"
                    Case 800 : Num2Text = "OCHOCIENTOS"
