...
Public Class frm_reporte_cotizacion
    ...
    Private Sub frm_reporte_cotizacion_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Me.CenterToParent()
    ...
    Private Sub btnBuscar_Click(sender As Object, e As EventArgs) Handles btnBuscar.Click
        Try
            ...
            If txtIDTipoCredito.Text = "" Then
                crParameterDiscreteValue.Value = 0
            Else
                crParameterDiscreteValue.Value = txtIDTipoCredito.Text
            End If
            crParameterFiledDefinitions = ObjRpt.DataDefinition.ParameterFields
            ...
            If txtIDGrupocxc.Text = "" Then
                crParameterDiscreteValue.Value = 0
            Else
                crParameterDiscreteValue.Value = txtIDGrupocxc.Text
            End If
            crParameterFiledDefinitions = ObjRpt.DataDefinition.ParameterFields
    ...
    Private Sub txtIDTipoCredito_Leave(sender As Object, e As EventArgs) Handles txtIDTipoCredito.Leave
        ConLibregco.Open()
        cmd = New MySqlCommand("SELECT Descripcion FROM TipoCredito Where IDTipoCredito='" + txtIDTipoCredito.Text + "'", ConLibregco)
        txtTipoCredito.Text = Convert.ToString(cmd.ExecuteScalar())
        ConLibregco.Close()
        If txtTipoCredito.Text = "" Then txtIDTipoCredito.Clear()
    End Sub

    Private Sub txtIDGrupocxc_Leave(sender As Object, e As EventArgs) Handles txtIDGrupocxc.Leave
        ConLibregco.Open()
        cmd = New MySqlCommand("SELECT Descripcion FROM Grupocxc Where IDGrupocxc='" + txtIDGrupocxc.Text + "'", ConLibregco)
        txtGrupocxc.Text = Convert.ToString(cmd.ExecuteScalar())
        ConLibregco.Close()
        If txtGrupocxc.Text = "" Then txtIDGrupocxc.Clear()
    End Sub

    Private Sub btnBucarTipo_Click(sender As Object, e As EventArgs) Handles btnBucarTipo.Click
