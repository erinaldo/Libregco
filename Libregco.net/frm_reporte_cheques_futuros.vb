...
Public Class frm_reporte_cheques_futuros
    ...
    Private Sub frm_reporte_cheques_futuros_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Me.CenterToParent()
    ...
    Private Sub btnBuscar_Click(sender As Object, e As EventArgs) Handles btnBuscar.Click
        Try
            ...
            If chkSinEspecificarFechaRegistro.Checked = False Then
            ...
            crParameterValues = crParameterFieldDefinition.CurrentValues
            crParameterRangeValue = New ParameterRangeValue
            If chkSinEspecificarDeposito.Checked = False Then
                With crParameterRangeValue
                    .StartValue = dtpFechaInicial.Value.ToString("yyyy-MM-dd")
                    .UpperBoundType = RangeBoundType.BoundInclusive
                    .EndValue = dtpFechaFinal.Value.ToString("yyyy-MM-dd")
    ...
    Private Sub chkSinEspecificarFechaRegistro_CheckedChanged(sender As Object, e As EventArgs) Handles chkSinEspecificarFechaRegistro.CheckedChanged
        If chkSinEspecificarFechaRegistro.Checked = True Then
    ...
    Private Sub chkSinEspecificarDeposito_CheckedChanged(sender As Object, e As EventArgs) Handles chkSinEspecificarDeposito.CheckedChanged
        If chkSinEspecificarDeposito.Checked = True Then
            dtpFechaInicialDeposito.Enabled = False
            dtpFechaFinalDeposito.Enabled = False
        Else
            dtpFechaInicialDeposito.Enabled = True
            dtpFechaFinalDeposito.Enabled = True
        End If
    End Sub
End Class