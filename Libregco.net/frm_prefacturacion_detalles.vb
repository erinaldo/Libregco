...
Public Class frm_prefacturacion_detalles
    Friend IDPreFactura As New Label
    Dim sqlQ As String=""
    ...
    Private Sub frm_prefacturacion_detalles_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub btnContinuar_Click(sender As Object, e As EventArgs) Handles btnContinuar.Click
        Try
            If Me.Owner.Name = frm_prefacturacion.Name Then
                ...
                If frm_prefacturacion.txtIDFactura.Text = "" Then
                    If CInt(DTConfiguracion.Rows(176 - 1).Item("Value2Int")) = 1 Then
                ...
                If txtIDCliente.Text = "" Then
                    ...
                    MessageBox.Show("Seleccione el cliente para procesar la prefactura.", "No se ha específicado el cliente", MessageBoxButtons.OK, MessageBoxIcon.Information, MessageBoxDefaultButton.Button1)
                    btnBuscarCliente.PerformClick()
                    Exit Sub
                ElseIf txtNombre.Text = "" Then
                    lblStatusBar.Text = "Verificando nombre del cliente..."
                    MessageBox.Show("Escriba el nombre del cliente de la prefactura a procesar.", "Nombre del cliente", MessageBoxButtons.OK, MessageBoxIcon.Information, MessageBoxDefaultButton.Button1)
                    txtNombre.Focus()
                    Exit Sub
                ...
                ElseIf CInt(DTConfiguracion.Rows(97 - 1).Item("Value2Int")) = 1 And txtNombre.Text.Contains("CONTADO") And CDbl(txtNeto.Text) > CDbl(DTConfiguracion.Rows(98 - 1).Item("Value3Double")) Then
                    lblStatusBar.Text = "Verificando requerimientos del monto de la factura..."
                    MessageBox.Show("El monto total de la factura (" & txtNeto.Text & ") " & "excede el límite máximo establecido (" & CDbl(DTConfiguracion.Rows(98 - 1).Item("Value3Double")).ToString("C") & ") para facturas sin el respectivo nombre del cliente." & vbNewLine & vbNewLine & "Por favor escriba el nombre del cliente para continuar con la factura.", "Escriba el nombre del cliente", MessageBoxButtons.OK, MessageBoxIcon.Information, MessageBoxDefaultButton.Button1)
                    lblStatusBar.Text = "El monto total de la factura (" & txtNeto.Text & ") " & "excede el límite máximo establecido (" & CDbl(DTConfiguracion.Rows(98 - 1).Item("Value3Double")).ToString("C") & ") para facturas sin el respectivo nombre del cliente"
                    txtNombre.Focus()
                    txtNombre.SelectAll()
                    Exit Sub
                ...
                ElseIf txtVendedor.Text = "" Or txtIDVendedor.Text = "" Then
                    ...
                    If txtIDVendedor.Text <> "" Then
                        txtIDVendedor.Clear()
                    End If
                    MessageBox.Show("Escriba el código del vendedor para registrar la prefactura.", "Código del vendedor", MessageBoxButtons.OK, MessageBoxIcon.Information, MessageBoxDefaultButton.Button1)
                    txtIDVendedor.Focus()

                    Exit Sub
                ElseIf txtIDCondicion.Text = "" Then
                    lblStatusBar.Text = "Verificando condición de la venta..."
                    MessageBox.Show("Seleccione el tipo de condición de la prefactura.", "Condición de prefacturación", MessageBoxButtons.OK, MessageBoxIcon.Information, MessageBoxDefaultButton.Button1)
                ...
                ElseIf rdbCreditoFiscal.Checked = True Or txtIDNcf.Text <> 2 Then
                    ...
                    If RN = "" Then
                        MessageBox.Show("Se ha detectado que la factura a procesar posee comprobante fiscal." & vbNewLine & vbNewLine & "Por favor específique el RNC o cédula de identidad para continuar con la prefactura.", "RNC Vacío", MessageBoxButtons.OK, MessageBoxIcon.Information, MessageBoxDefaultButton.Button1)
                        txtRNC.Focus()
                        txtRNC.SelectAll()
                        Exit Sub

                    ElseIf frm_prefacturacion.CantidadCaracteresRNC.Contains(RN.Length) = False Then
                        MessageBox.Show("Se ha detectado que la factura a procesar posee comprobante fiscal." & vbNewLine & vbNewLine & "Por favor complete el RNC o cédula de identidad para continuar con la prefactura.", "RNC no completado", MessageBoxButtons.OK, MessageBoxIcon.Information, MessageBoxDefaultButton.Button1)
                        txtRNC.Focus()
                        txtRNC.SelectAll()
                        Exit Sub
                    End If
                ...
                Dim Result As MsgBoxResult = MessageBox.Show("Este es el último paso para procesar la prefacturación." & vbNewLine & vbNewLine & "Está seguro que desea continuar?", "Procesar Prefactura", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1)
                If Result = MsgBoxResult.Yes Then
                    ...
                    ControlSuperClave = 0
                    frm_prefacturacion.txtNombre.Text = txtNombre.Text
                    frm_prefacturacion.txtIDCondicion.Text = txtIDCondicion.Text
            ...
            ElseIf Me.Owner.Name = frm_mdi_prefacturacion.name Then
                ...
                If DirectCast(Owner.ActiveMdiChild, frm_prefacturacion_new).txtIDFactura.Text = "" Then
                    If CInt(DTConfiguracion.Rows(176 - 1).Item("Value2Int")) = 1 Then
                        If txtNombre.Text.Contains("SRL") Or txtNombre.Text.Contains("S.R.L") Or txtNombre.Text.Contains("EIRL") Or txtNombre.Text.Contains("E.I.R.L") Or txtNombre.Text.Contains("S.A") Or txtNombre.Text.Contains(" S A") Or txtNombre.Text.Contains("CXA") Or txtNombre.Text.Contains("C.X.A") Or txtNombre.Text.Contains("C POR A") And rdbCreditoFiscal.Checked = False Then
                            rdbCreditoFiscal.Checked = True
                            lblStatusBar.Text = "El tipo de comprobante fiscal se ha cambiado a " & txtTipoNcf.Text & "."
                ...
                ElseIf rdbCreditoFiscal.Checked = True Or txtIDNcf.Text <> 2 Then
                    ...
                    ElseIf DirectCast(Owner.ActiveMdiChild, frm_prefacturacion_new).CantidadCaracteresRNC.Contains(RN.Length) = False Then
                        MessageBox.Show("Se ha detectado que la factura a procesar posee comprobante fiscal." & vbNewLine & vbNewLine & "Por favor complete el RNC o cédula de identidad para continuar con la prefactura.", "RNC no completado", MessageBoxButtons.OK, MessageBoxIcon.Information, MessageBoxDefaultButton.Button1)
                        txtRNC.Focus()
                        txtRNC.SelectAll()
                        Exit Sub
                ...
                If Result = MsgBoxResult.Yes Then
                    ...
                    ControlSuperClave = 0
                    DirectCast(Owner.ActiveMdiChild, frm_prefacturacion_new).txtNombre.Text = txtNombre.Text
                    DirectCast(Owner.ActiveMdiChild, frm_prefacturacion_new).txtIDCondicion.Text = txtIDCondicion.Text
    ...
    Private Sub btnCancelar_Click(sender As Object, e As EventArgs) Handles btnCancelar.Click
        ...
        Dim Result As MsgBoxResult = MessageBox.Show("Está seguro que desea cancelar la prefactura?", "Detener Proceso de Prefactura", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1)
        If Result = MsgBoxResult.Yes Then
            ControlSuperClave = 1
        ...
        Try
            ...
            If Me.Owner.Name = frm_prefacturacion.Name Then
                ...
                Else
                    ...
                    Else
                        If txtIDCliente.Text <> Tabla.Rows(0).Item("IDCliente") Then
    ...
    Private Sub frm_prefacturacion_detalles_KeyDown(sender As Object, e As KeyEventArgs) Handles MyBase.KeyDown
    ...
    Private Sub txtNombre_KeyDown(sender As Object, e As KeyEventArgs) Handles txtNombre.KeyDown
        ...
        ElseIf e.KeyCode = Keys.Down Then
            If DgvNombre.Visible = True Then
                DgvNombre.Focus()
            Else
                e.Handled = True
                SendKeys.Send("{TAB}")
            ...
            If Me.Visible = True Then
                ...
                If txtIDCliente.Text = "1" Then
                    If Len(txtNombre.Text) > 0 Then
                        ...
                        Ds.Clear()
                        'cmd = New MySqlCommand("SELECT FacturaDatos.NombreFactura as Nombre,IdentificacionFactura as RNC FROM" & SysName.Text & "FacturaDatos Where FacturaDatos.IDCliente=1 and length(NombreFactura)>50 and FacturaDatos.NombreFactura like '%" + txtNombre.Text + "%' GROUP BY NombreFactura Order by NombreFactura ASC LIMIT 50", ConMixta)
                        cmd = New MySqlCommand("SELECT FacturaDatos.NombreFactura as Nombre,IdentificacionFactura as RNC,DireccionFactura,TelefonosFactura FROM" & SysName.Text & "FacturaDatos Where FacturaDatos.IDCliente=1 and LENGTH(REPLACE(NombreFactura,' ',''))>10 and FacturaDatos.NombreFactura like '%" + txtNombre.Text + "%' GROUP BY NombreFactura Having Count(*)>5 Order by NombreFactura ASC LIMIT 50", ConMixta)
                        Adaptador = New MySqlDataAdapter(cmd)
                        ...
                        DgvNombre.Columns(2).Visible = False
                        DgvNombre.Columns(3).Visible = False
    ...
    Private Sub txtIDCliente_TextChanged(sender As Object, e As EventArgs) Handles txtIDCliente.TextChanged
        If Me.Visible = True Then
            If Me.Owner.Name = frm_prefacturacion.Name Then
                frm_prefacturacion.txtIDCliente.Text = txtIDCliente.Text
            ElseIf Me.Owner.Name = frm_mdi_prefacturacion.Name Then
                DirectCast(Owner.ActiveMdiChild, frm_prefacturacion_new).txtIDCliente.Text = txtIDCliente.Text
            End If
        End If
    End Sub
    ...
    Private Sub DgvNombre_CellClick(sender As Object, e As DataGridViewCellEventArgs) Handles DgvNombre.CellClick
        Try
            If e.RowIndex >= 0 Then
                ...
                txtDireccion.Text = DgvNombre.CurrentRow.Cells(2).Value
                txtTelefono.Text = DgvNombre.CurrentRow.Cells(3).Value
    ...
    Private Sub frm_prefacturacion_detalles_FormClosing(sender As Object, e As FormClosingEventArgs) Handles MyBase.FormClosing
    ...
    Private Sub txtOrden_TextChanged(sender As Object, e As EventArgs) Handles txtOrden.TextChanged
        If Me.Visible = True Then
            If Me.Owner.Name = frm_prefacturacion.Name Then
                frm_prefacturacion.txtOrden.Text = txtOrden.Text

            ElseIf Me.Owner.Name = frm_mdi_prefacturacion.Name Then
                DirectCast(Owner.ActiveMdiChild, frm_prefacturacion_new).txtOrden.Text = txtOrden.Text
            End If
        End If
    ...
    Private Sub txtDireccion_TextChanged(sender As Object, e As EventArgs) Handles txtDireccion.TextChanged
        If Me.Visible = True Then
            If Me.Owner.Name = frm_prefacturacion.Name Then
                frm_prefacturacion.DireccionCliente = txtDireccion.Text
            ElseIf Me.Owner.Name = frm_mdi_prefacturacion.Name Then
                DirectCast(Owner.ActiveMdiChild, frm_prefacturacion_new).DireccionCliente = txtDireccion.Text
            End If
        End If
    End Sub
    ...
    Private Sub txtRNC_TextChanged(sender As Object, e As EventArgs) Handles txtRNC.TextChanged
        If Me.Visible = True Then
            If Me.Owner.Name = frm_prefacturacion.Name Then
                frm_prefacturacion.RNCliente = txtRNC.Text
            ElseIf Me.Owner.Name = frm_mdi_prefacturacion.Name Then
                DirectCast(Owner.ActiveMdiChild, frm_prefacturacion_new).RNCliente = txtRNC.Text
            End If
        End If
    End Sub
    ...
    Private Sub txtTelefono_TextChanged(sender As Object, e As EventArgs) Handles txtTelefono.TextChanged
        If Me.Visible = True Then
            If Me.Owner.Name = frm_prefacturacion.Name Then
                frm_prefacturacion.TelefonoCliente = txtTelefono.Text
            ElseIf Me.Owner.Name = frm_mdi_prefacturacion.Name Then
                DirectCast(Owner.ActiveMdiChild, frm_prefacturacion_new).TelefonoCliente = txtTelefono.Text
            End If
        End If
    End Sub
End Class