...
Public Class Watermark
    ...
    Private Sub CreateWatermark()
        ...
        AddHandler WaterContainer.MouseHover, AddressOf Hovered
        AddHandler WaterContainer.MouseLeave, AddressOf Leaving
    End Sub
    ...
    Private Sub Hovered(sender As Object, e As EventArgs)
        Try
            If TypeOf DirectCast(Me.Parent.Parent.Parent.Parent, Control) Is NewTextbox Then
                If DirectCast(Me.Parent.Parent.Parent.Parent, NewTextbox).Watermark1.Focused = False Then
                    DirectCast(Me.Parent.Parent, ShapedPanel).BackColor = DirectCast(Me.Parent.Parent.Parent.Parent, NewTextbox).SetBackColorOnMouseEnter
                End If
    ...
    Private Sub Leaving(sender As Object, e As EventArgs)
        Try
            If TypeOf DirectCast(Me.Parent.Parent.Parent.Parent, Control) Is NewTextbox Then
                If DirectCast(Me.Parent.Parent.Parent.Parent, NewTextbox).Watermark1.Focused = False Then
                    DirectCast(Me.Parent.Parent, ShapedPanel).BackColor = DirectCast(Me.Parent.Parent.Parent.Parent, NewTextbox).SetDefaultBackColor
                End If
