...
Public Class frm_reporte_solicitud_cheques
    ...
    Private Sub frm_reporte_solicitud_cheques_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Me.CenterToParent()
    ...
    Private Sub txtValor_Leave(sender As Object, e As EventArgs) Handles txtValor.Leave
        ...
        Else
            If IsNumeric(txtValor.Text) Then
                txtValor.Text = CDbl(txtValor.Text).ToString("C")
            End If
        End If
    End Sub
    ...
    Private Sub txtValor_Enter(sender As Object, e As EventArgs) Handles txtValor.Enter
        ...
        Else
            If IsNumeric(txtValor.Text) Then
                txtValor.Text = CDbl(txtValor.Text)
            End If
        End If
    End Sub
    ...
    Private Sub btnBuscar_Click(sender As Object, e As EventArgs) Handles btnBuscar.Click
        Try
            ...
            Else
                crParameterDiscreteValue.Value = txtBeneficiario.Text
            End If
            crParameterFiledDefinitions = ObjRpt.DataDefinition.ParameterFields
            ...
            If txtValor.Text = "" Then
                crParameterDiscreteValue.Value = 0
            Else
                crParameterDiscreteValue.Value = CDbl(txtValor.Text)
            End If
            crParameterFiledDefinitions = ObjRpt.DataDefinition.ParameterFields
