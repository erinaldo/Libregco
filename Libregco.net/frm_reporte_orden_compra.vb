...
Public Class frm_reporte_orden_compra
    ...
    Dim IDReport, NameReport, PathReport, OrdenCampo, OrdenFormula, lblIDCondicion, lblIDStatus As New Label
    Dim Permisos As New ArrayList

    Private Sub frm_reporte_orden_compra_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Me.CenterToParent()
    ...
    Private Sub FillStatus()
        ...
        cbxStatus.Items.Add("Todas")

        If Tabla.Rows.Count > 0 Then
        Else
            MessageBox.Show("No se encontraron status de ordenes. Inserte status de ordenes de compra hábiles para procesar los registros.", "No se encontraron tipos de ordenes", MessageBoxButtons.OK, MessageBoxIcon.Error, MessageBoxDefaultButton.Button1)
            Close()
        End If
    ...
    Private Sub CbxFormato_SelectedIndexChanged(sender As Object, e As EventArgs) Handles CbxFormato.SelectedIndexChanged
        ...
        Catch ex As Exception
            MessageBox.Show(ex.Message.ToString & "CbxFormato_SelectedIndex")
        End Try
    End Sub
    ...
    Private Sub cbxStatus_SelectedIndexChanged(sender As Object, e As EventArgs) Handles cbxStatus.SelectedIndexChanged
        If cbxStatus.Text <> "Todas" Then
            ConLibregco.Open()
            cmd = New MySqlCommand("SELECT IDTipoOrdenCompra FROM TipoOrdenCompra WHERE Descripcion= '" + cbxStatus.SelectedItem + "'", ConLibregco)
            lblIDStatus.Text = Convert.ToString(cmd.ExecuteScalar())
            ConLibregco.Close()
        End If
    End Sub
    ...
    Private Sub btnBuscar_Click(sender As Object, e As EventArgs) Handles btnBuscar.Click
        Try
            ...
            If cbxStatus.Text = "Todas" Then
                crParameterDiscreteValue.Value = 0
            Else
                crParameterDiscreteValue.Value = lblIDStatus.Text
            End If
            crParameterFiledDefinitions = ObjRpt.DataDefinition.ParameterFields
    ...
    Private Sub txtIDArticulo_Leave(sender As Object, e As EventArgs) Handles txtIDProducto.Leave
        ConLibregco.Open()
