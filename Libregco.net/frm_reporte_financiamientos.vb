...
Public Class frm_reporte_financiamientos
    Dim sqlQ As String=""
    ...
    Private Sub frm_reporte_financiamientos_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Me.CenterToParent()
    ...
    Private Sub LimpiarTodo()
        ...
        cbxBalance.Text = "Todos"
        cbxBalanceCuotas.Text = "Todas"
    End Sub
    ...
    Private Sub btnBuscar_Click(sender As Object, e As EventArgs) Handles btnBuscar.Click
        ...
        'Balance
        If cbxBalance.Text = "Todos" Then
                crParameterDiscreteValue.Value = 0
            ElseIf cbxBalance.Text = "Sólo pendientes" Then
                crParameterDiscreteValue.Value = 1
            ElseIf cbxBalance.Text = "En cero" Then
                crParameterDiscreteValue.Value = 2
            End If
            crParameterFiledDefinitions = ObjRpt.DataDefinition.ParameterFields
            ...
            'BalanceCuotas
            If cbxBalanceCuotas.Text = "Todas" Then
                crParameterDiscreteValue.Value = 0
            ElseIf cbxBalanceCuotas.Text = "Sólo pendientes" Then
                crParameterDiscreteValue.Value = 1
            ElseIf cbxBalanceCuotas.Text = "En cero" Then
                crParameterDiscreteValue.Value = 2
            End If
            crParameterFiledDefinitions = ObjRpt.DataDefinition.ParameterFields
            crParameterFieldDefinition = crParameterFiledDefinitions.Item("@BalanceCuotas")
            crParameterValues.Add(crParameterDiscreteValue)
            crParameterFieldDefinition.ApplyCurrentValues(crParameterValues)
        ...
        crParameterValues.Add(crParameterDiscreteValue)
            ...
            '@FechaVencimientoCuotas
            If rdbTodasCuotas.Checked = True Then
                crParameterDiscreteValue.Value = 0
            ElseIf rdbVencidasCuotas.Checked = True Then
                crParameterDiscreteValue.Value = 1
            ElseIf rdbCuotasNoVencidas.Checked = True Then
                crParameterDiscreteValue.Value = 2
            End If
            crParameterFiledDefinitions = ObjRpt.DataDefinition.ParameterFields
            crParameterFieldDefinition = crParameterFiledDefinitions.Item("@FechaVencimientoCuotas")
            crParameterValues.Add(crParameterDiscreteValue)
            crParameterFieldDefinition.ApplyCurrentValues(crParameterValues)
