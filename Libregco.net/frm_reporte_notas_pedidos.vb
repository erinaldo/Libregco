...
Public Class frm_reporte_notas_pedidos
    ...
    Private Sub frm_reporte_notas_pedidos_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
            Me.CenterToParent()
    ...
    Private Sub btnBuscar_Click(sender As Object, e As EventArgs) Handles btnBuscar.Click
        Try
            ...
            '@Cierre
            If chkCierre.Checked = False Then
                crParameterDiscreteValue.Value = 0
            Else
                crParameterDiscreteValue.Value = 1
            End If
