...
Public Class frm_reporte_ajustes_inventario
    ...
    Private Sub frm_reporte_ajustes_inventario_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
            Me.CenterToParent()
    ...
    Private Sub txtIDTipoAjuste_Leave(sender As Object, e As EventArgs) Handles txtIDTipoAjuste.Leave
        ConLibregco.Open()
        cmd = New MySqlCommand("Select TipodeAjuste from TipodeAjuste Where IDAjusteInventario='" + txtIDTipoAjuste.Text + "'", ConLibregco)
        txtTipoAjuste.Text = Convert.ToString(cmd.ExecuteScalar())
        ConLibregco.Close()
        If txtTipoAjuste.Text = "" Then txtIDTipoAjuste.Clear()
    End Sub

    Private Sub btnBuscarTipodeAjuste_Click(sender As Object, e As EventArgs) Handles btnBuscarTipodeAjuste.Click
    ...
    Private Sub btnBuscar_Click(sender As Object, e As EventArgs) Handles btnBuscar.Click
        Try
            ...
            If txtIDTipoAjuste.Text = "" Then
                crParameterDiscreteValue.Value = 0
            Else
                crParameterDiscreteValue.Value = txtIDTipoAjuste.Text
            End If
            crParameterFiledDefinitions = ObjRpt.DataDefinition.ParameterFields
