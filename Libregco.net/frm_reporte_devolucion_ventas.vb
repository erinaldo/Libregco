...
Public Class frm_reporte_devolucion_ventas
    ...
    Private Sub frm_reporte_devolucion_ventas_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Me.CenterToParent()
    ...
    Private Sub LimpiarTodo()
        ...
        txtIDMotivo.Clear()
        txtMotivo.Clear()
        txtIDTipoDevolucion.Clear()
        txtTipoDevolucion.Clear()
        txtIDSuplidor.Clear()
        txtSuplidor.Clear()
        txtIDMarca.Clear()
        txtMarca.Clear()
        ...
        ChkItbisDevuelto.Checked = False
    ...
    Private Sub btnTipoDevolucion_Click(sender As Object, e As EventArgs) Handles btnTipoDevolucion.Click
        frm_buscar_tipo_devolucion_venta.ShowDialog(Me)
    End Sub

    Private Sub btnSuplidor_Click_1(sender As Object, e As EventArgs) Handles btnSuplidor.Click
    ...
    Private Sub txtIDProducto_Leave(sender As Object, e As EventArgs) Handles txtIDProducto.Leave
        ConLibregco.Open()
        cmd = New MySqlCommand("SELECT Descripcion FROM Articulos WHERE IDArticulo= '" + txtIDProducto.Text + "'", ConLibregco)
        txtProducto.Text = Convert.ToString(cmd.ExecuteScalar())
        ConLibregco.Close()
        If txtProducto.Text = "" Then txtIDProducto.Clear()
    End Sub

    Private Sub txtIDMotivo_Leave(sender As Object, e As EventArgs) Handles txtIDMotivo.Leave
        ConLibregco.Open()
        cmd = New MySqlCommand("SELECT Descripcion FROM MotivoDevolucion WHERE IDMotivoDevolucion= '" + txtIDMotivo.Text + "'", ConLibregco)
        txtMotivo.Text = Convert.ToString(cmd.ExecuteScalar())
        ConLibregco.Close()
        If txtMotivo.Text = "" Then txtIDMotivo.Clear()
    End Sub
    ...
    Private Sub txtIDTipoDevolucion_Leave(sender As Object, e As EventArgs) Handles txtIDTipoDevolucion.Leave
        ConLibregco.Open()
        cmd = New MySqlCommand("SELECT Tipo FROM TipoDevolucion WHERE IDTipoDevolucion= '" + txtIDTipoDevolucion.Text + "'", ConLibregco)
        txtTipoDevolucion.Text = Convert.ToString(cmd.ExecuteScalar())
        ConLibregco.Close()
    End Sub
    ...
    Private Sub btnBuscar_Click(sender As Object, e As EventArgs) Handles btnBuscar.Click
        Try
            ...
            If txtIDProducto.Text = "" Then
                crParameterDiscreteValue.Value = 0
            Else
                crParameterDiscreteValue.Value = txtIDProducto.Text
            End If
            crParameterFiledDefinitions = ObjRpt.DataDefinition.ParameterFields
            ...
            '@Motivo
            If txtIDMotivo.Text = "" Then
                crParameterDiscreteValue.Value = 0
            Else
                crParameterDiscreteValue.Value = txtIDMotivo.Text
            End If
            crParameterFiledDefinitions = ObjRpt.DataDefinition.ParameterFields
            ...
            '@Tipo
            If txtIDTipoDevolucion.Text = "" Then
                crParameterDiscreteValue.Value = 0
            Else
                crParameterDiscreteValue.Value = txtIDTipoDevolucion.Text
            End If
            crParameterFiledDefinitions = ObjRpt.DataDefinition.ParameterFields
            ...
            '@ItbisDevuelto
            If ChkItbisDevuelto.Checked = True Then
                crParameterDiscreteValue.Value = 1
            Else
                crParameterDiscreteValue.Value = 0
            End If
            ...
            If cbxCondicion.Text = "Todas" Then
                crParameterDiscreteValue.Value = 0
            ElseIf cbxCondicion.Text = "Contado" Then
                crParameterDiscreteValue.Value = 1
            ElseIf cbxCondicion.Text = "Crédito" Then
