...
Public Class frm_reporte_movimientos_bancarios
    ...
    Private Sub frm_buscar_movimientos_bancarios_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Me.CenterToParent()
    ...
    Private Sub btnBuscar_Click(sender As Object, e As EventArgs) Handles btnBuscar.Click
        Try
            ...
            '@NCF
            If cbxNCF.Text = "Todos" Then
                crParameterDiscreteValue.Value = 0
            ElseIf cbxNCF.Text = "Sin NCF" Then
                crParameterDiscreteValue.Value = 1
            ElseIf cbxNCF.Text = "Sólo con NCF" Then
                crParameterDiscreteValue.Value = 2
            End If
            crParameterFiledDefinitions = ObjRpt.DataDefinition.ParameterFields
            ...
            '@NCFComo
            If txtNCFComo.Text = "" Then
                crParameterDiscreteValue.Value = ""
            Else
                crParameterDiscreteValue.Value = txtNCFComo.Text
            End If
            crParameterFiledDefinitions = ObjRpt.DataDefinition.ParameterFields
    ...
    Private Sub txtIDTipoMovimiento_Leave(sender As Object, e As EventArgs) Handles txtIDTipoMovimiento.Leave
        ConLibregco.Open()
        cmd = New MySqlCommand("SELECT TipoMovimiento FROM tipomovbancario where IDTipoMovBancario='" + txtIDTipoMovimiento.Text + "'", ConLibregco)
        txtTipoMovimiento.Text = Convert.ToString(cmd.ExecuteScalar())
        ConLibregco.Close()
        If txtTipoMovimiento.Text = "" Then txtIDTipoMovimiento.Clear()
    End Sub
    ...
    Private Sub txtIDCuenta_Leave(sender As Object, e As EventArgs) Handles txtIDCuenta.Leave
        ...
        txtCuenta.Text = Convert.ToString(cmd.ExecuteScalar())
        Con.Close()
        If txtCuenta.Text = "" Then txtIDCuenta.Clear()
    End Sub
