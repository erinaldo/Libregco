...
Public Class frm_reporte_registro_facturas_cxp
    ...
    Private Sub frm_reporte_registro_facturas_cxp_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Me.CenterToParent()
    ...
    Private Sub ActualizarTodo()
        ...
        cbxPrecioDiferido.Text = "Todos"
        cbxCreditoPend.Text = "Todos"
        cbxAveriados.Text = "Todos"
        cbxArtfuerapedido.Text = "Todos"
        cbxNegociarFlete.Text = "Todos"
    End Sub
    ...
    Private Sub btnBuscar_Click(sender As Object, e As EventArgs) Handles btnBuscar.Click
        Try
            ...
            '@PrecioDiferido
            If cbxPrecioDiferido.Text = "Todos" Then
                crParameterDiscreteValue.Value = 2
            ElseIf cbxPrecioDiferido.Text = "Sí" Then
                crParameterDiscreteValue.Value = 1
            ElseIf cbxPrecioDiferido.Text = "No" Then
                crParameterDiscreteValue.Value = 0
            End If
            crParameterFiledDefinitions = ObjRpt.DataDefinition.ParameterFields
            crParameterFieldDefinition = crParameterFiledDefinitions.Item("@PrecioDiferido")
            crParameterValues.Add(crParameterDiscreteValue)
            crParameterFieldDefinition.ApplyCurrentValues(crParameterValues)

            '@CreditoPendiente
            If cbxCreditoPend.Text = "Todos" Then
                crParameterDiscreteValue.Value = 2
            ElseIf cbxCreditoPend.Text = "Sí" Then
                crParameterDiscreteValue.Value = 1
            ElseIf cbxCreditoPend.Text = "No" Then
                crParameterDiscreteValue.Value = 0
            End If
            crParameterFiledDefinitions = ObjRpt.DataDefinition.ParameterFields
            crParameterFieldDefinition = crParameterFiledDefinitions.Item("@CreditoPendiente")
            crParameterValues.Add(crParameterDiscreteValue)
            crParameterFieldDefinition.ApplyCurrentValues(crParameterValues)

            '@Averiados
            If cbxAveriados.Text = "Todos" Then
                crParameterDiscreteValue.Value = 2
            ElseIf cbxAveriados.Text = "Sí" Then
                crParameterDiscreteValue.Value = 1
            ElseIf cbxAveriados.Text = "No" Then
                crParameterDiscreteValue.Value = 0
            End If
            crParameterFiledDefinitions = ObjRpt.DataDefinition.ParameterFields
            crParameterFieldDefinition = crParameterFiledDefinitions.Item("@Averiados")
            crParameterValues.Add(crParameterDiscreteValue)
            crParameterFieldDefinition.ApplyCurrentValues(crParameterValues)

            '@ArticulosFuera
            If cbxArtfuerapedido.Text = "Todos" Then
                crParameterDiscreteValue.Value = 2
            ElseIf cbxArtfuerapedido.Text = "Sí" Then
                crParameterDiscreteValue.Value = 1
            ElseIf cbxArtfuerapedido.Text = "No" Then
                crParameterDiscreteValue.Value = 0
            End If
            crParameterFiledDefinitions = ObjRpt.DataDefinition.ParameterFields
            crParameterFieldDefinition = crParameterFiledDefinitions.Item("@ArticuloFuera")
            crParameterValues.Add(crParameterDiscreteValue)
            crParameterFieldDefinition.ApplyCurrentValues(crParameterValues)

            '@NegociarFlete
            If cbxNegociarFlete.Text = "Todos" Then
                crParameterDiscreteValue.Value = 2
            ElseIf cbxNegociarFlete.Text = "Sí" Then
                crParameterDiscreteValue.Value = 1
            ElseIf cbxNegociarFlete.Text = "No" Then
                crParameterDiscreteValue.Value = 0
            End If
            crParameterFiledDefinitions = ObjRpt.DataDefinition.ParameterFields
            crParameterFieldDefinition = crParameterFiledDefinitions.Item("@NegociarFlete")
            crParameterValues.Add(crParameterDiscreteValue)
            crParameterFieldDefinition.ApplyCurrentValues(crParameterValues)
