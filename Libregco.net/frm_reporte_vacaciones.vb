...
Public Class frm_reporte_vacaciones
    Dim sqlQ As String=""
    ...
    Private Sub frm_reporte_vacaciones_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Me.CenterToParent()
    ...
    Private Sub FillReportes()
        Try
            Ds.Clear()
            Con.Open()
            cmd = New MySqlCommand("SELECT Descripcion FROM Reportes INNER JOIN PaperSize on Reportes.IDPaperName=PaperSize.IDPaperSize Where MenuString='VacacionesListado'", Con)
    ...
    Private Sub btnBuscar_Click(sender As Object, e As EventArgs) Handles btnBuscar.Click
        ...
        'RangoFechas()
        If chkEspecificarVenc.Checked = False Then
            If dtpIngresoFinal.Value = dtpIngresoFinal.Value Then
                ObjRpt.SetParameterValue("@RangoFechas", "Del " & dtpIngresoInicial.Value.ToString("dd/MM/yyyy"))
            Else
                ObjRpt.SetParameterValue("@RangoFechas", "Desde " & dtpIngresoInicial.Value.ToString("dd/MM/yyyy") & " Hasta " & dtpIngresoFinal.Value.ToString("dd/MM/yyyy"))
