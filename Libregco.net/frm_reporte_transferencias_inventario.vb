...
Public Class frm_reporte_transferencias_inventario
    ...
    Private Sub frm_reporte_transferencias_inventario_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
            Me.CenterToParent()
    ...
    Private Sub txtIDAlmacenEnt_Leave(sender As Object, e As EventArgs) Handles txtIDAlmacenEnt.Leave
        ...
        Con.Close()
        If txtAlmacenEnt.Text = "" Then txtIDAlmacenEnt.Clear()
    End Sub
    ...
    Private Sub txtIDAlmacenSal_Leave(sender As Object, e As EventArgs) Handles txtIDAlmacenSal.Leave
        ...
        Con.Close()
        If txtAlmacenSal.Text = "" Then txtIDAlmacenSal.Clear()
    End Sub
    ...
    Private Sub btnAlmacenEnt_Click(sender As Object, e As EventArgs) Handles btnAlmacenEnt.Click
        frm_buscar_almacen_mant.Control = 1
        frm_buscar_almacen_mant.ShowDialog(Me)
    End Sub

    Private Sub btnAlmacenSal_Click(sender As Object, e As EventArgs) Handles btnAlmacenSal.Click
        frm_buscar_almacen_mant.Control = 2
        frm_buscar_almacen_mant.ShowDialog(Me)
    End Sub
