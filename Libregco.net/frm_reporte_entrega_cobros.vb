...
Public Class frm_reporte_entrega_cobros
    Dim sqlQ As String=""
    ...
    Private Sub frm_reporte_entrega_cobros_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Me.CenterToParent()
    ...
    Private Sub FillReportes()
        Try
            Ds.Clear()
            Con.Open()
            cmd = New MySqlCommand("SELECT Descripcion FROM Reportes INNER JOIN PaperSize on Reportes.IDPaperName=PaperSize.IDPaperSize Where MenuString='ListadoEntregasCobros'", Con)
    ...
    Private Sub txtIDFactura_Leave(sender As Object, e As EventArgs) Handles txtIDFactura.Leave
        Con.Open()
        cmd = New MySqlCommand("Select IDFacturaDatos from FacturaDatos Where IDFacturaDatos='" + txtIDFactura.Text + "'", Con)
