...
Public Class frm_reporte_cobros_facturas
    ...
    Private Sub frm_reporte_cobros_facturas_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Me.CenterToParent()
    ...
    Private Sub FillCondicion()
        ...
        Ds.Clear()
        ConLibregco.Open()
        cmd = New MySqlCommand("SELECT Condicion FROM Condicion ORDER BY Orden ASC", ConLibregco)
    ...
    Private Sub ActualizarTodo()
        ...
        chkDepositos.Checked = True
        chkCheques.Checked = True
        chkCreditos.Checked = True
    ...
    Private Sub btnBuscar_Click(sender As Object, e As EventArgs) Handles btnBuscar.Click
        Try
            ...
            If chkIncluirTodo.Checked = True Then
                crParameterDiscreteValue.Value = 0
            ...
            Else
                ...
                '@Efectivo
                If chkEfectivo.Checked = True Then
                    crParameterDiscreteValue.Value = 1
                Else
                    crParameterDiscreteValue.Value = 0
                End If
                ...
                '@Credito
                If chkCreditos.Checked = True Then
                    crParameterDiscreteValue.Value = 1
                Else
                    crParameterDiscreteValue.Value = 0
                End If
                ...
                '@Tarjeta
                If chkTarjetas.Checked = True Then
                    crParameterDiscreteValue.Value = 1
                Else
                    crParameterDiscreteValue.Value = 0
                End If
            ...
            'RangoFechas()
            If chkEspecificar.Checked = True Then
                ObjRpt.SetParameterValue("@RangoFechas", "Hasta el " & dtpFechaFinal.Value.ToString("dd/MM/yyyy"))
            Else
                ...
                Else
                    ObjRpt.SetParameterValue("@RangoFechas", "Desde el" & dtpFechaInicial.Value.ToString("dd/MM/yyyy") & " hasta " & dtpFechaFinal.Value.ToString("dd/MM/yyyy"))
                End If
            End If
            'Usuario Info
    ...
    Private Sub chkIncluirTodo_CheckedChanged(sender As Object, e As EventArgs) Handles chkIncluirTodo.CheckedChanged
        If chkIncluirTodo.Checked = True Then
            chkEfectivo.Enabled = False
            chkTarjetas.Enabled = False
            chkCheques.Enabled = False
            chkDepositos.Enabled = False
        ...
        Else
            ...
            chkTarjetas.Enabled = True
            chkCheques.Enabled = True
            chkDepositos.Enabled = True
