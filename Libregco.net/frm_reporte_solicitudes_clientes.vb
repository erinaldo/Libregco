...
Public Class frm_reporte_solicitudes_clientes
    ...
    Dim IDReport, NameReport, PathReport, OrdenCampo, OrdenFormula, lblIDCondicion As New Label
    Dim Permisos As New ArrayList

    Private Sub frm_reporte_solicitudes_clientes_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Me.CenterToParent()
    ...
    Private Sub txtIDClase_Leave(sender As Object, e As EventArgs) Handles txtIDClase.Leave
        ConLibregco.Open()
        cmd = New MySqlCommand("SELECT Clase FROM tiposmemos Where IDTiposMemos='" + txtIDClase.Text + "'", ConLibregco)
        txtClase.Text = Convert.ToString(cmd.ExecuteScalar())
        ConLibregco.Close()
        If txtClase.Text = "" Then txtIDClase.Clear()
    End Sub

    Private Sub txtIDPrioridad_Leave(sender As Object, e As EventArgs) Handles txtIDPrioridad.Leave
        ConLibregco.Open()
        cmd = New MySqlCommand("SELECT Prioridad FROM Prioridad Where IDPrioridad='" + txtIDPrioridad.Text + "'", ConLibregco)
        txtPrioridad.Text = Convert.ToString(cmd.ExecuteScalar())
        ConLibregco.Close()
        If txtPrioridad.Text = "" Then txtIDPrioridad.Clear()
    End Sub

    Private Sub chkSinEspecVenc_CheckedChanged(sender As Object, e As EventArgs) Handles chkSinEspecVenc.CheckedChanged
        If chkSinEspecVenc.Checked = True Then
    ...
    Private Sub btnBuscar_Click(sender As Object, e As EventArgs) Handles btnBuscar.Click
        Try
            ...
            If txtIDClase.Text = "" Then
                crParameterDiscreteValue.Value = 0
            Else
                crParameterDiscreteValue.Value = txtIDClase.Text
            End If
            crParameterFiledDefinitions = ObjRpt.DataDefinition.ParameterFields
            ...
            '@Prioridad
            If txtIDPrioridad.Text = "" Then
                crParameterDiscreteValue.Value = 0
            Else
                crParameterDiscreteValue.Value = txtIDPrioridad.Text
            End If
            crParameterFiledDefinitions = ObjRpt.DataDefinition.ParameterFields
            ...
            '@Finalizado
            If cbxEstadoSolicitud.Text = "Todos" Then
                crParameterDiscreteValue.Value = 2
            ElseIf cbxEstadoSolicitud.Text = "Activos" Then
                crParameterDiscreteValue.Value = 0
            ElseIf cbxEstadoSolicitud.Text = "Finalizados" Then
                crParameterDiscreteValue.Value = 1
            End If
            crParameterFiledDefinitions = ObjRpt.DataDefinition.ParameterFields
