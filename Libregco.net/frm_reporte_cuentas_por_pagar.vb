...
Public Class frm_reporte_cuentas_por_pagar
    ...
    Private Sub frm_reporte_cuentas_por_pagar_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Me.CenterToParent()
    ...
    Private Sub FillReportes()
        Try
            Ds.Clear()
            Con.Open()
            cmd = New MySqlCommand("SELECT Descripcion FROM Reportes INNER JOIN PaperSize on Reportes.IDPaperName=PaperSize.IDPaperSize Where MenuString='Compras pendientes' and Reportes.Activo=1 and PaperSize.Activo=1 ORDER BY NoOrden ASC", Con)
