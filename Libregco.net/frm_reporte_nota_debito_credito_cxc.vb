...
Public Class frm_reporte_nota_debito_credito_cxc
    ...
    Private Sub frm_reporte_nota_debito_credito_cxc_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Me.CenterToParent()
    ...
    Private Sub btnTipoNota_Click(sender As Object, e As EventArgs) Handles btnTipoNota.Click
    ...
    Private Sub btnBuscar_Click(sender As Object, e As EventArgs) Handles btnBuscar.Click
        Try
            ...
            '@TipoSalidaNota
            If txtIDTipoNota.Text = "" Then
                crParameterDiscreteValue.Value = 0
            Else
                crParameterDiscreteValue.Value = txtIDTipoNota.Text
            End If
            crParameterFiledDefinitions = ObjRpt.DataDefinition.ParameterFields
            ...
            '@GenerarNCF
            If cbxGenerarNCF.Text = "Todas" Then
                crParameterDiscreteValue.Value = 2
            ElseIf cbxGenerarNCF.Text = "Aplican" Then
                crParameterDiscreteValue.Value = 1
            ElseIf cbxGenerarNCF.Text = "No Aplican" Then
                crParameterDiscreteValue.Value = 0
            End If
            crParameterFiledDefinitions = ObjRpt.DataDefinition.ParameterFields
    ...
    Private Sub txtIDTipoNota_Leave(sender As Object, e As EventArgs) Handles txtIDTipoNota.Leave
        ConLibregco.Open()
        cmd = New MySqlCommand("SELECT Tipo FROM tipodevolucion Where IDTipoDevolucion='" + txtIDTipoNota.Text + "'", ConLibregco)
        txtTipoNota.Text = Convert.ToString(cmd.ExecuteScalar())
        ConLibregco.Close()
        If txtTipoNota.Text = "" Then txtIDTipoNota.Clear()
    End Sub
